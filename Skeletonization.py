...
INPUT_POINT_CLOUDS_DIR = "C:/Users/Olav/Documents/GitHub/RootPruning/pointClouds"
...
class Skeletonization:
    ...
    def loadPointCloud(self):
        ...
        """
        scene = Scene(INPUT_POINT_CLOUDS_DIR + 'FakeFlower.ply')
        points = scene[0].geometry.pointList
        return points

    def find_root(self, points):
        """
    ...
    def skeleton(self, points, binratio = 50, k = 20):
        """
        ...
        """
        root, zmin, zmax = self.find_root(points)
    ...
    def main(self): 
        ...
        """
        points = self.loadPointCloud()
        mtg = self.skeleton(points)
        tree = self.readMTGobject(mtg)
        #self.saveList(tree)
        return tree
